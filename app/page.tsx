  ...
  return (
    <>
      ...
      <LandingPrimaryImageCtaSection
        ...
        description="Take charge of your finances with Finovate. Your money, clear and simple."
      ...
      <LandingProductSteps
        title="How it Works"
        description="Get started with Finovate in three simple steps. No complicated setup, no hidden fees."
        display="grid"
        withBackground={false}
        variant="primary"
      >
      ...
      <LandingTestimonialReadMoreWrapper>
        <LandingTestimonialGrid
          ...
          description="See what our customers have to say about managing their finances with Finovate."
          testimonialItems={[
            {
              name: 'Sarah Anderson',
              text: 'Finovate made budgeting so much easier for me. I can finally see where my money goes each month and make smarter decisions about my spending.',
            ...
            {
              name: 'John Bennett',
              text: "Finovate helped me finally understand where my money goes each month. Now I feel in control of my finances and I'm actually saving money for the first time.",
              handle: '@johnbennett',
            ...
            {
              name: 'Maria Garcia',
              text: "The automatic savings feature is a game changer. I've saved more in three months with Finovate than I did all last year trying to do it manually.",
              handle: '@mariagarcia',
            ...
            {
              name: 'Jessica Lee',
              text: 'Finovate has completely changed how I think about money. The insights and reports help me make better financial decisions every single day.',
              handle: '@jessicalee',
            ...
            },
            {
              ...
              text: "I was skeptical at first, but Finovate has exceeded all my expectations. It's intuitive, powerful, and has genuinely improved my financial health.",
      ...
      <LandingFaqCollapsibleSection
        ...
        description="Got questions? We've got answers. Find everything you need to know about Finovate."
        faqItems={[
          {
            question: 'Is Finovate free to use?',
            answer:
              'Yes! Finovate offers a free plan with essential features. We also have premium plans with advanced features for users who need more functionality. There are no hidden fees or surprise charges.',
          },
          {
          ...
          {
            question: 'Which banks can I connect to Finovate?',
            answer:
              'Finovate supports thousands of banks and credit unions across the United States. We work with all major banks and most regional institutions. If you have questions about a specific bank, please contact our support team.',
          },
          {
            question: 'Can I use Finovate on my phone?',
            answer:
              'Absolutely! Finovate works seamlessly on all devices including smartphones, tablets, and desktop computers. Access your finances anytime, anywhere with our responsive web app.',
          },
          {
          ...
          },
          {
            ...
            answer:
              'Our customer support team is here to help! You can reach us via email, live chat, or phone. We also have a comprehensive help center with guides and tutorials to help you get the most out of Finovate.',
          },
        ]}
        withBackground={false}
        withBackgroundGlow={false}
      ...
      <LandingSaleCtaSection
        title="Ready to take control? Join Finovate today."
