      ...
      <div className="w-full flex flex-col items-center my-12">
        <section className="w-full p-6 container-narrow">
          ...
          <p className="mt-6 md:text-xl">
            Welcome to the Finovate FAQ. Here you'll find answers to the most
            common questions about managing your money with us.
          </p>

          <p className="mt-6 md:text-xl">
            <strong>How do I get started with Finovate?</strong> Signing up is
          ...
          <p className="mt-6 md:text-xl">
            <strong>Can I use Finovate on any device?</strong> Yes, our platform
